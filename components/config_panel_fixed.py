...
class ConfigPanel:
    ...
    def create_ui(self):
        ...
        self.text_box.bind("<KeyRelease>", lambda e: self.update_shared_name(self.text_box))
        ...
        # Track text changes in this field
        self.advanced_text_box.bind("<KeyRelease>", lambda e: self.update_shared_name(self.advanced_text_box))
        ...
        # Track text changes in this field
        self.software_text_box.bind("<KeyRelease>", lambda e: self.update_shared_name(self.software_text_box))
        ...
        browse_button = tk.Button(path_frame, text="Browse...", bg="gray40", fg="white", 
                                command=self.browse_software)
        ...
        # Track text changes in this field
        self.text_tab_name_box.bind("<KeyRelease>", lambda e: self.update_shared_name(self.text_tab_name_box))
    ...
    def update_shared_name(self, source_textbox):
        ...
        # Only update other textboxes to avoid infinite loop
        all_textboxes = [self.text_box, self.advanced_text_box, 
                         self.software_text_box, self.text_tab_name_box]
        
        for textbox in all_textboxes:
            if textbox != source_textbox:
                # Clear and update
                textbox.delete("1.0", "end")
                textbox.insert("1.0", self.shared_name)
    ...
    def sync_name_fields(self, event=None):
        ...
        if current_tab == 0:  # Basic tab
            ...
            self.text_box.insert("1.0", self.shared_name)
        elif current_tab == 1:  # Advanced tab
            self.advanced_text_box.delete("1.0", "end")
            self.advanced_text_box.insert("1.0", self.shared_name)
        elif current_tab == 2:  # Software tab
            self.software_text_box.delete("1.0", "end")
            self.software_text_box.insert("1.0", self.shared_name)
        elif current_tab == 3:  # Text tab
            self.text_tab_name_box.delete("1.0", "end")
            self.text_tab_name_box.insert("1.0", self.shared_name)
    ...
    def load_key_data(self):
        ...
        if self.app and hasattr(self.app, 'selected_profile') and hasattr(self.app, 'selected_key'):
            ...
            if profile_index in profiles and key_index in profiles[profile_index]:
                ...
                self.advanced_text_box.delete("1.0", "end")
                self.advanced_text_box.insert("1.0", name)
                
                self.software_text_box.delete("1.0", "end")
                self.software_text_box.insert("1.0", name)
                
                self.text_tab_name_box.delete("1.0", "end")
                self.text_tab_name_box.insert("1.0", name)
    ...
    def browse_software(self):
        ...
        if file_path:
            ...
            if not self.software_text_box.get("1.0", "end-1c").strip():
                ...
                # Update shared name
                self.update_shared_name(self.software_text_box)
    ...
    def save_config(self):
        ...
        # Use the shared name for all tabs
    ...
    def save_text_config(self):
        ...
        # Get the name and text content (using shared name)
        name = self.shared_name
